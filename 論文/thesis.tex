...
%   \caption{尺度 5：インスタンスサイズの増加に伴う，同一並列機械モデルと無関連並列機械モデルの競合比の比較．表~\ref{A5}，\ref{A7} 参照．}
%\label{5.6}
% \end{figure}
...
%   \centering
%   \includegraphics[width = 16cm]{figure/ptTimeId.pdf}
%   \caption{尺度 6：インスタンスサイズの増加に伴う，同一並列機械モデルと無関連並列機械モデルの計算時間の比較．表~\ref{A6}，\ref{A8} 参照．}
%\label{5.7}
% \end{figure}
