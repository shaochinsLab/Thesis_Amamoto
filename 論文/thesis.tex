...
\begin{itemize}
  ...
  最大待ち時間最小化問題における待ち時間が $w \neq 0$ のとき，JIT ジョブ荷重和最大化問題との共通点はなくなる．JIT ジョブ荷重和最大化問題は，納期以前に処理を完了したジョブ，つまり JIT ジョブの荷重和を最大化する問題であり，すべてのジョブが JIT ジョブである必要はない．
