...
% \begin{figure}[h]
%   \centering
%   \includegraphics[width = 13cm]{figure/rgfTimeUn.pdf}
...
%   \caption{尺度 5：同一並列機械モデルにおける最大待ち時間最小化問題に対するヒューリスティックの競合比．表~\ref{A5} 参照．}
%   \label{5.5}
% \end{figure}
...
%   \centering
%   \includegraphics[width = 16cm]{figure/}
%   \caption{尺度 5：無関連並列機械モデルにおける最大待ち時間最小化問題に対するヒューリスティックの競合比．表~\ref{A6} 参照．}
%   \label{5.6}
% \end{figure}
